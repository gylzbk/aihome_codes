...
static int check_sort(struct test_case *test)
{
	...
	if (counter[0].addr != (void *)0x3)
		return 0;
	if (counter[1].addr != (void *)0x2)
		return 0;
	if (counter[2].addr != (void *)0x1)
		return 0;
...
{
	printf("fake_free 0x1111 three times.\n");
	printf("fake_free 0x2222 two times.\n");
	printf("fake_free 0x3333 once.\n");
}
