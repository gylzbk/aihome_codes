#ifndef __MOZART_EVENT_STR_H__
#define __MOZART_EVENT_STR_H__

/* keyvalue2str for EV_KEY, ONLY for debug. */
static __attribute__((unused)) char *keyvalue_str[] = {
	[0] = "Released",
	[1] = "Pressed",
};

/* keycode2str for EV_KEY, ONLY for debug. */
static __attribute__((unused)) char *keycode_str[] = {
