...
extern "C" {
	...
	/**
	 * @brief scan sdcard mount dir(/mnt/sdcard).
	 */
	extern int mozart_localplayer_scan(void);
	...
	/**
	 * @brief get current music's url in /mnt/sdcard.
	 *
	 */
	char *mozart_localplayer_get_current_url(void);

	//TODO
        extern void mozart_localplayer_set_playmode(void);
#ifdef __cplusplus
}
#endif
