 ...
 **
 **
 **  Copyright (c) 2008-2014, Broadcom Corp., All Rights Reserved.
...
#define btm_multi_adv_cb (*btm_multi_adv_ptr)
	...
	extern void btm_ble_brcm_irk_list_known_dev(BOOLEAN enable);

	extern tBTM_STATUS btm_ble_read_irk_entry(BD_ADDR target_bda);
	extern void btm_ble_brcm_disable_irk_list(void);
	extern BOOLEAN btm_ble_brcm_irk_list_load_dev(tBTM_SEC_DEV_REC *p_dev_rec);
	extern void btm_ble_brcm_irk_list_remove_dev(tBTM_SEC_DEV_REC *p_dev_rec);
