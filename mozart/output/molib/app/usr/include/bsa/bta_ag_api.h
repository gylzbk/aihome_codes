...
#define BTA_AG_FAIL_COLLISION   4 /* Connection collision  */
...
#if FALSE   /* Not Used in Bluetooth HFP 1.5 Specification; listed for reference only */
...
typedef struct
{
	...
	BOOLEAN             is_initiator;    /* is initiator role or not */
