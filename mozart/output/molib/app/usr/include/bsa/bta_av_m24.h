...
/*******************************************************************************
 **
 ** Function         bta_av_m24_cfg_for_cap
 **
 ...
 **
 *******************************************************************************/
extern UINT8 bta_av_m24_cfg_for_cap(UINT8 *p_peer, tA2D_M24_CIE *p_cap, tA2D_M24_CIE *p_pref);

/*******************************************************************************
 **
 ** Function         bta_av_m24_cfg_in_cap
 **
 ...
 **
 *******************************************************************************/
extern UINT8 bta_av_m24_cfg_in_cap(UINT8 *p_cfg, tA2D_M24_CIE *p_cap);
