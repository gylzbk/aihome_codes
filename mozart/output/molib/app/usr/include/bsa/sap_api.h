...
#define SAP_ERR_GENERAL                 5   /* General SAP error */ /* BSA_SPECIFIC */
#define SAP_ERR_BAD_HANDLE              6   /* Bad connection handle */ /* BSA_SPECIFIC */
...
#define SAP_TRANS_PROCOTOL_T_0          0   /* Type 0 */ /* BSA_SPECIFIC */
#define SAP_TRANS_PROCOTOL_T_1          1   /* Type 1 */ /* BSA_SPECIFIC */
...
#define SAP_RESULT_CARD_ALREADY_OFF     3   /* Error - card is already powered off. */ /* BSA_SPECIFIC */
#define SAP_RESULT_CARD_REMOVED         4   /* Error - card is not inserted. */
#define SAP_RESULT_CARD_ALREADY_ON      5   /* Error - card is already powered on. */ /* BSA_SPECIFIC */
#define SAP_RESULT_DATA_NOT_AVAILABLE   6   /* Error - data not available. */
#define SAP_RESULT_NOT_SUPPORTED        7   /* Error - not supported */ /* BSA_SPECIFIC */
...
#define SAP_SET_TRANS_PROTOCOL_RESP_EVT 0x15    /* SET_TRANSPORT_PROTOCOL_RESP received */ /* BSA_SPECIFIC */
...
#if (defined(SAP_CLIENT_INCLUDED) && SAP_CLIENT_INCLUDED == TRUE) /* BSA_SPECIFIC */
...
typedef void (tSAP_CLIENT_CBACK)(tSAP_EVT event, tSAP_EVT_DATA *p_evt_data); /* BSA_SPECIFIC */
