...
extern "C"
{
	 ...
	 **
	 *****************************************************************************/
	UDRV_API BOOLEAN UAMP_Init(tUAMP_CBACK *p_cback);
	 ...
	 **
	 *****************************************************************************/
	UDRV_API BOOLEAN UAMP_Open(tUAMP_ID amp_id);
	 ...
	 **
	 *****************************************************************************/
	UDRV_API void UAMP_Close(tUAMP_ID amp_id);
	 ...
	 **
	 *****************************************************************************/
	UDRV_API UINT16 UAMP_Write(tUAMP_ID amp_id, UINT8 *p_buf, UINT16 num_bytes, tUAMP_CH channel);
	 ...
	 **
	 *****************************************************************************/
	UDRV_API UINT16 UAMP_WriteBuf(tUAMP_ID amp_id, BT_HDR *p_msg);
	 ...
	 **
	 *****************************************************************************/
	UDRV_API UINT16 UAMP_Read(tUAMP_ID amp_id, UINT8 *p_buf, UINT16 buf_size, tUAMP_CH channel);
