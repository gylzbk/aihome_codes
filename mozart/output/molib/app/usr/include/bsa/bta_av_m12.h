...
#define BTA_AV_M12_HDR_SIZE         A2D_M12_MPL_HDR_LEN


/*******************************************************************************
 **
 ** Function         bta_av_m12_cfg_for_cap
 **
 ...
 **
 *******************************************************************************/
extern UINT8 bta_av_m12_cfg_for_cap(UINT8 *p_peer, tA2D_M12_CIE *p_cap, tA2D_M12_CIE *p_pref);

/*******************************************************************************
 **
 ** Function         bta_av_m12_cfg_in_cap
 **
 ...
 **
 *******************************************************************************/
extern void bta_av_m12_bld_hdr(BT_HDR *p_buf, UINT16 frag_offset);
