...
typedef enum sta_error{
	...
	CONNECT_TIMEOUT,
	/*
	 * @brief Station connect timeout alltime.
	 */
	CONNECT_TIMEOUT_ALLTIME,
	/*
...
typedef enum netcfg_method {
	...
	SOFTAP,
	/**
	 * @brief airkiss(wechat) method for other wifi module(exp:relatek, Use WeChat provide airkiss static library).
	 */
	AIRKISS_WE,
	/**
