...
extern "C" {
	...
	typedef struct misc_event {
		char name[16]; /* Possible name: "tfcard", "linein", "headset", "dlna", "airplay", "bt" ... */
		char type[16]; /* EVENT_CONNECT_CONNECTED/DISCONNECTED */
		int  value[4]; /* EVENT_CONNECT_CONNECTED/DISCONNECTED */
	} misc_event;
	...
	extern int mozart_event_try_connect(void);
