...
extern "C" {
	...
	/**
	 * @brief force stop the music(kill mplayer, Generally DO NOT invoke it), you will NOT recieve PLAYER_STOPPED status on callback.
	 *
	 * @param handler [in] player handler
	 *
	 * @return return 0 on success, return -1 otherwise
	 ...
	 * @return return 0 on success, return -1 otherwise
	 */
	extern int mozart_player_forcestop(player_handler_t *handler);
	 ...
	 * @param handler [in] player handler
	 *
	 * @return return uuid on success, return NULL otherwise
	 */
